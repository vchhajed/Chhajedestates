...
const ongoingProjects = [
  {
    id: "vatsalya",
    name: "Vatsalya Tower",
    tagline: "Jain Temple In The Premises • 95 Lacs Onwards",
    location: "Near Shatrunjay Jain Temple, Kondhwa (BK)",
    ...
    highlights: [
      "Jain Temple IN the premises — rare & auspicious",
  ...
  },
  {
    id: "emerald",
    name: "Emerald Vista",
    tagline: "Ultra-Spacious 2 & 3 BHK • Last 5 Units Left",
    location: "Ekbote Colony, Near Seven Loves Chowk",
    sublocation: "Pune — Vastu Compliant, Near Jain Mandir",
    config: "2 & 3 BHK",
    units: 12,
    amenities: null,
    possession: "Next 12 Months",
    rera: "P52100076742",
    status: "Last 5 Units!",
    statusColor: "bg-red-500/20 text-red-400 border-red-500/30",
    price: "₹1.31 Cr onwards",
    priceNote: "All inclusive price",
    ...
    sizes: [
      "2 BHK — 832 sq.ft carpet (₹1.31 Cr all-in)",
      "3 BHK — 1120 sq.ft carpet (₹1.81 Cr all-in)",
    ],
  ...
  },
  {
    ...
    tagline: "XXL Homes with Exclusive Living • Rooftop Amenities",
    location: "Timber Merchant Colony, Nr. Seven Loves Chowk",
    sublocation: "Pune — Jain Mandir Nearby",
    config: "3 & 4 BHK Luxury",
    units: 14,
    amenities: 6,
    possession: "On Request",
    rera: null,
    status: "Luxury — Nov 2024",
  ...
  },
  {
    ...
    tagline: "Nature's Harmony • The Oasis of Greens",
    ...
    highlights: [
      ...
      "Project onboarded February 2025",
